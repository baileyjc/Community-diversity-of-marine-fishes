...
sum(is.na(complete_traits$RepGuild1))
sum(is.na(complete_traits$RepGuild2))
sum(is.na(complete_traits$ParentalCare))
...
sum(fromGenus) 
sum(is.na(complete_traits[3:20]))
...
sum(fromFamily)
sum(is.na(complete_imputed[3:20]))
