...
### Environmental
# Surveyed sites
FD_FRic_env_am <- aov(log(pd.obs) ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FRic_env_am)
p_values <- summary(FD_FRic_env_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FRic_env_lm <- lm(log(pd.obs) ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[surveyed_sites_env,])
summary(FD_FRic_env_lm)
p_values <- summary(FD_FRic_env_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_z_env_am <- aov(pd.obs.z ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_z_env_am)
p_values <- summary(FD_z_env_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_z_env_lm <- lm(pd.obs.z ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[surveyed_sites_env,])
summary(FD_z_env_lm)
p_values <- summary(FD_z_env_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_FDisp_env_am <- aov(Dispersion ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FDisp_env_am)
p_values <- summary(FD_FDisp_env_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FDisp_env_lm <- lm(Dispersion ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[surveyed_sites_env,])
...
FD_FRic_env_MS_am <- aov(log(pd.obs) ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FRic_env_MS_am)
p_values <- summary(FD_FRic_env_MS_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FRic_env_MS_lm <- lm(log(pd.obs) ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[mixed_stratified_lakes,])
summary(FD_FRic_env_MS_lm)
p_values <- summary(FD_FRic_env_MS_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_z_env_MS_am <- aov(pd.obs.z ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_z_env_MS_am)
p_values <- summary(FD_z_env_MS_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_z_env_MS_lm <- lm(pd.obs.z ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[mixed_stratified_lakes,])
summary(FD_z_env_MS_lm)
p_values <- summary(FD_z_env_MS_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_FDisp_env_MS_am <- aov(Dispersion ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FDisp_env_MS_am)
p_values <- summary(FD_FDisp_env_MS_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FDisp_env_MS_lm <- lm(Dispersion ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[mixed_stratified_lakes,])
...
FD_FRic_env_OM_am <- aov(log(pd.obs) ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FRic_env_OM_am)
p_values <- summary(FD_FRic_env_OM_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FRic_env_OM_lm <- lm(log(pd.obs) ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_mixed_sites_env,])
summary(FD_FRic_env_OM_lm)
p_values <- summary(FD_FRic_env_OM_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_z_env_OM_am <- aov(pd.obs.z ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_z_env_OM_am)
p_values <- summary(FD_z_env_OM_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_z_env_OM_lm <- lm(pd.obs.z ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_mixed_sites_env,])
summary(FD_z_env_OM_lm)
p_values <- summary(FD_z_env_OM_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_FDisp_env_OM_am <- aov(Dispersion ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FDisp_env_OM_am)
p_values <- summary(FD_FDisp_env_OM_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FDisp_env_OM_lm <- lm(Dispersion ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_mixed_sites_env,])
...
FD_FRic_env_SO_am <- aov(log(pd.obs) ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FRic_env_SO_am)
p_values <- summary(FD_FRic_env_SO_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FRic_env_SO_lm <- lm(log(pd.obs) ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_stratified_sites_env,])
summary(FD_FRic_env_SO_lm)
p_values <- summary(FD_FRic_env_SO_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_z_env_SO_am <- aov(pd.obs.z ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_z_env_SO_am)
p_values <- summary(FD_z_env_SO_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_z_env_SO_lm <- lm(pd.obs.z ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_stratified_sites_env,])
summary(FD_z_env_SO_lm)
p_values <- summary(FD_z_env_SO_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_FDisp_env_SO_am <- aov(Dispersion ~ (salinity_median + oxygen_median + temperature_median) * Site_type, data = straits_sespd_env[surveyed_sites_env,])
summary(FD_FDisp_env_SO_am)
p_values <- summary(FD_FDisp_env_SO_am)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))
FD_FDisp_env_SO_lm <- lm(Dispersion ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_stratified_sites_env,])
...
# Ocean sites
FD_FRic_env_O_lm <- lm(log(pd.obs) ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_sites,])
summary(FD_FRic_env_O_lm)
p_values <- summary(FD_FRic_env_O_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_z_env_O_lm <- lm(pd.obs.z ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_sites,])
summary(FD_z_env_O_lm)
p_values <- summary(FD_z_env_O_lm)$coefficients[, "Pr(>|t|)"]
(adjusted_p_values <- p.adjust(p_values, method = "bonferroni"))

FD_FDisp_env_O_lm <- lm(Dispersion ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[ocean_sites,])
...
# Mixed lakes
FD_FRic_env_M_lm <- lm(log(pd.obs) ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[mixed_lakes,])
...
# Stratified lakes
FD_FRic_env_S_lm <- lm(log(pd.obs) ~ salinity_median + oxygen_median + temperature_median, straits_sespd_env[stratified_lakes,])
...
### Geographical
# Surveyed sites
FD_FRic_geo_am <- aov(log(pd.obs) ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[surveyed_sites,])
...
FD_z_geo_am <- aov(log(pd.obs) ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[surveyed_sites,])
summary(FD_z_geo_am)
...
FD_FDisp_geo_am <- aov(log(pd.obs) ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[surveyed_sites,])
...
# Mixed and stratified lakes
FD_FRic_geo_MS_am <- aov(log(pd.obs) ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[mixed_stratified_lakes,])
...
FD_z_geo_MS_am <- aov(pd.obs.z ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[mixed_stratified_lakes,])
...
FD_FDisp_geo_MS_am <- aov(Dispersion ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[mixed_stratified_lakes,])
...
# Ocean sites and mixed lakes
FD_FRic_geo_OM_am <- aov(log(pd.obs) ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[ocean_mixed_sites,])
...
FD_z_geo_OM_am <- aov(pd.obs.z ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[ocean_mixed_sites,])
...
FD_FDisp_geo_OM_am <- aov(Dispersion ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[ocean_mixed_sites,])
...
# Stratified lakes and ocean sites
FD_FRic_geo_SO_am <- aov(log(pd.obs) ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[ocean_stratified_sites,])
...
FD_z_geo_SO_am <- aov(pd.obs.z ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[ocean_stratified_sites,])
...
FD_FDisp_geo_SO_am <- aov(Dispersion ~ (distance_to_ocean_min_m + max_depth + logArea) * Site_type, data = straits_sespd_env[ocean_stratified_sites,])
